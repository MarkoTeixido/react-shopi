  ...
  return (
    <div className='bg-white cursor-pointer w-56 h-60 border rounded-md' onClick={() => showProduct(data.data)}>
      <figure className='relative mb-2 w-full h-4/5'>
        ...
        <div className='absolute top-0 right-0 flex justify-center items-center bg-white w-6 h-6 rounded-full m-2 transition duration-150 hover:bg-opacity-80 hover:ease-linear hover:rotate-90' onClick={() => context.setCount(context.count + 1)}>
